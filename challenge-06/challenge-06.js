...
*/
// ?
var teams = ['Santos', 'Santo André', 'São Paulo',  'Guarani', 'Palmeiras'];
...
function showTeamPosition(position) {
    ...
    return "O time que está em " + position + "º lugar é o " + teams[i] + ".";
    }
...
function convertToHex(color) {
    switch(color) {
        ...
        case 'roxo':
          return 'O hexadecimal para a cor " + color + " é #A020F0.';
        case 'rosa':
